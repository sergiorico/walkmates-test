...
`GET /api/match/{seekerId}/explain` contract — 200 + JSON body on success, 404 when the seeker or
listing is missing. You are testing the **interface**, not a live model.
...
Repo link/commit + short trend comparison + completed
[`reflection-template.md`](reflection-template.md).
