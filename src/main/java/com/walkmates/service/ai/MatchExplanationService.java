 ...
 *   <li>{@link #recommendBestMatch(Seeker, List)} is deterministic and ignores free-text bios,
 *       which is what makes the metamorphic relations MR-1/MR-2 hold (FR-5.3).</li>
 * </ul>
 */
@Service
public class MatchExplanationService {
     ...
     * result is independent of free-text bios (MR-1) and of input order (MR-2).
     *
     * @param seeker     the Seeker (reserved for future scoring; bios are deliberately ignored)
